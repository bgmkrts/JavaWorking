...
public class Equals {
	...
	public static void main(String[] args) {
		Object k1=new Kisi(5,"begüm");
        System.out.println(k1);

        Object k2=new Kisi(5,"begüm");
        System.out.println(k2);


        System.out.println("k1 ve k2 eşit mi :" + ((Kisi) k1).equals((Kisi)k2));
        System.out.println("k1 hashcode:"+k1.hashCode()+" k2:"+k2.hashCode());

        /*k1 = k2;
        Calisan calisan=new Calisan(5,"begüm");
        System.out.println("k1 ve k2 eşit mi :" + k1.equals(calisan));
*/
        String isim=new String("begüm");
        String isim2=new String("begüm");
