...
public class Cozum4 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Kullanıcının girdiği öğrenci sayısı ve kullanıcının girdiği toplam soru
		 * sayısına bağlı olarak, öğrencilerin soruya verdiği cevapları tutan bir matris
		 * Bu değerleri rastgele olarak olusturun. Değerler A,B,C,D,E olmalı. Bir de
		 * doğru cevapları tutan tek boyutlu bir diziniz olsun. Bu da rastgele
		 * oluşturulmalı. Sonrasında bu değerleri karşılaştırarak her bi öğrencinin kaç
		 * doğru ve yanlışı olduğunu gösteren programı yazınız.
		 */
